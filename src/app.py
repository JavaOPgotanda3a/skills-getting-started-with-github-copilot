...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team drills, scrimmages, and fitness training",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 24,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Basketball Training": {
        "description": "Shoot around, teamwork, and competitive play",
    ...
    "Drama Workshop": {
        "description": "Acting exercises, scene study, and stage performance",
